...
namespace Microsoft.Practices.ParallelGuideSamples.ImagePipeline.Gui
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// quitButton
			// 
			this.quitButton.Location = new System.Drawing.Point(464, 247);
			...
			this.textBoxPhase1AvgTime.ReadOnly = true;
			...
			this.textBoxPhase2AvgTime.ReadOnly = true;
			...
			this.textBoxPhase3AvgTime.ReadOnly = true;
			...
			this.textBoxPhase4AvgTime.ReadOnly = true;
			...
			// textBoxImageCount
			// 
			this.textBoxImageCount.Location = new System.Drawing.Point(262, 217);
			...
			// textBoxFps
			// 
			this.textBoxFps.Location = new System.Drawing.Point(473, 217);
			...
			this.textBoxQueue1AvgWait.ReadOnly = true;
			...
			this.textBoxQueue2AvgWait.ReadOnly = true;
			...
			this.textBoxQueue3AvgWait.ReadOnly = true;
			...
			this.textBoxQueueCount1.ReadOnly = true;
			...
			this.textBoxQueueCount2.ReadOnly = true;
			...
			this.textBoxQueueCount3.ReadOnly = true;
			...
			// buttonStart
			// 
			this.buttonStart.Location = new System.Drawing.Point(324, 247);
			...
			this.radioButtonPipeline.Location = new System.Drawing.Point(81, 14);
			...
			this.radioButtonLoadBalanced.Location = new System.Drawing.Point(151, 14);
			...
			// buttonStop
			// 
			this.buttonStop.Location = new System.Drawing.Point(391, 247);
			...
			this.label10.Location = new System.Drawing.Point(264, 197);
